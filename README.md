...
QNH or bug value. MC, QNH, or mosquito value can be set via the menu and the rotary encoder, and are then passed on 
...
position, XCSoar or a switch attached to the flaps automatically decides whether target travel or Vario should be active.
